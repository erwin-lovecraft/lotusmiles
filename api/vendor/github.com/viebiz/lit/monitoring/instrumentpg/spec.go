...
func (db instrumentedDB) PrepareContext(ctx context.Context, query string) (stmt *sql.Stmt, err error) {
	...
	return db.BeginnerExecutor.PrepareContext(ctx, query)
}
...
func (db instrumentedDB) ExecContext(ctx context.Context, query string, args ...interface{}) (rs sql.Result, err error) {
	...
	return db.BeginnerExecutor.ExecContext(ctx, query, args...)
}
...
func (db instrumentedDB) QueryContext(ctx context.Context, query string, args ...interface{}) (rows *sql.Rows, err error) {
	...
	return db.BeginnerExecutor.QueryContext(ctx, query, args...)
}
...
func (db instrumentedDB) QueryRowContext(ctx context.Context, query string, args ...interface{}) (row *sql.Row) {
	...
	return db.BeginnerExecutor.QueryRowContext(ctx, query, args...)
}
...
func (db instrumentedTx) PrepareContext(ctx context.Context, query string) (stmt *sql.Stmt, err error) {
	span := trace.SpanFromContext(ctx)
...
func (db instrumentedTx) ExecContext(ctx context.Context, query string, args ...interface{}) (rs sql.Result, err error) {
	span := trace.SpanFromContext(ctx)
...
func (db instrumentedTx) QueryContext(ctx context.Context, query string, args ...interface{}) (rows *sql.Rows, err error) {
	span := trace.SpanFromContext(ctx)
...
func (db instrumentedTx) QueryRowContext(ctx context.Context, query string, args ...interface{}) (row *sql.Row) {
	span := trace.SpanFromContext(ctx)
...
func (db instrumentedTx) recordError(span trace.Span, err error) {
	if err != nil {
		var pgErr *pgconn.PgError
		if errors.As(err, &pgErr) {
			span.AddEvent("Database Error", trace.WithAttributes(
