            ...
            <CardContent className="space-y-4 sm:space-y-6 pt-0">
              ...
              <div
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm sm:text-base">{memberData.currentTier.toUpperCase()}</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {user?.phone_number &&
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm sm:text-base text-gray-900">{user?.phone_number || "Empty"}</p>
                    </div>
                  </div>
                }
                <div className="flex items-start space-x-2 sm:col-span-2">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-sm sm:text-base text-gray-900">{user?.address || "Empty"}</p>
                  </div>
                </div>
                <div className="flex items-start space-x-2">
